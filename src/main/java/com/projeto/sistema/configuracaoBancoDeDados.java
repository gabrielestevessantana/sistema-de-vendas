...
public class configuracaoBancoDeDados {
	...
	public DataSource dataSource() {
		...
		dataSource.setDriverClassName("org.postgresql.Driver"); //Declara as configuracoes de acesso.
	...
	public JpaVendorAdapter jpaVendorAdapter() {
		...
		adapter.setDatabase(Database.POSTGRESQL); // DRIVER DO BANCO DE DADOS
